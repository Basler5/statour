...
class SearchRequest(models.Model):
    ...
    changing_the_departure_date = models.CharField(verbose_name="Возможное отклонение даты начала", max_length=10, choices=var_for_changing_date, default="0")
    ...
    changing_return_date = models.CharField(verbose_name="Возможное отклонение даты возвращения", max_length=10, choices=var_for_changing_date, default="0")
